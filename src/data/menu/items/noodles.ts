...
export const noodleMenuItems: MenuItem[] = [
  {
    ...
    steps: [
      ...
      {
        step: 2,
        content: "茄子蒸至约5分钟时，皮蛋放入碗中一并再蒸5分钟，不要直接放在蒸屉盖帘上",
      },
      {
        step: 3,
        content: "螺丝椒去根拍扁，无油无水干锅加盐，大火边按压边翻炒至出虎皮、软塌，盛出晾凉",
      },
      {
        step: 4,
      ...
      {
        step: 6,
        content: "面上放粗细辣椒面，冷油下花椒炸香后捞出花椒，趁热将油泼在辣椒面上激香",
      },
      {
        step: 7,
        content: "加生抽、陈醋、蚝油、白糖、味精、芝麻香油，抓拌均匀，尝咸淡后再决定是否补盐",
      },
    ],
  },
];
