...
export const meatEarlyMenuItems: MenuItem[] = [
  {
    ...
    steps: [
      ...
      {
        step: 3,
        content: "加生抽老抽冰糖炒至上色，倒入开水没过猪蹄，加1小勺醋，大火烧开转中小火炖1.5小时",
      },
      {
        step: 4,
        content: "放入鸡爪继续炖30分钟至软烂，大火收汁，加盐调味，撒小米辣和葱段出锅",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        step: 2,
        content: "干辣椒40g开水泡5分钟切碎成糍粑辣椒（糍粑辣椒没有可以不放），豆瓣酱1.5勺切碎备用",
      },
      {
        step: 3,
        content: "热油下葱姜蒜大火炒香，转中火炸至微黄，转小火下糍粑辣椒+豆瓣酱炒2分钟至无生味",
      },
      {
        step: 4,
      ...
      {
        step: 5,
        content: "转入高压锅，加水没过牛肉，加生抽、白胡椒粉、鸡精、味精、冰糖(暂不加盐)",
      },
      {
        step: 6,
        content: "电高压锅选牛羊肉模式；燃气高压锅上汽后小火30分钟；无高压锅则小火炖2小时以上",
      },
      {
        step: 7,
        content: "捞出牛肉过滤汤汁去料渣，汤汁回锅加盐调味，牛肉浸汤汁里，撒香菜出锅",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        step: 7,
        content: "倒入配菜大火翻炒1分钟即成干锅鸡公煲（加开水可煮配菜和方便面）",
      },
    ],
  },
];
