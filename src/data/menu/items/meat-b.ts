...
export const meatLateMenuItems: MenuItem[] = [
  {
    ...
    steps: [
      ...
      },
      {
        step: 6,
        content:
          "留底油炒香小料，倒入料汁与半碗清水，放回大虾大火收汁至汤汁粘稠即可，勿收干",
      },
      {
        step: 7,
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        step: 2,
        content:
          "空锅不放油，大火下螺丝椒，边按压边翻炒约1分钟，至表面起焦斑盛出备用",
      },
      {
        step: 3,
        content:
          "锅内加少量炒菜油，烧至冒烟后打入4个完整鸡蛋，煎至焦香凝固，铲成大块盛出",
      },
      {
        step: 4,
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        step: 4,
        content:
          "加清水或高汤，放入豆腐，加盐、白糖、老抽调味，中小火煮2～3分钟入味",
      },
      {
        step: 5,
        content:
          "水淀粉分三次下锅勾芡，每次轻推豆腐、勿大力搅拌，使汤汁逐步挂牢、收至合适稠度",
      },
      {
        step: 6,
        content:
          "倒回备用的牛肉末推匀，将豆腐舀起“盖帽”装盘，撒刀口辣椒与葱花即可",
      },
    ],
  },
];
